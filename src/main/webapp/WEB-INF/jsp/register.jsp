...
<section class="section-identification p-5 d-flex justify-content-center align-items-start container">
    <div class="card card-form text-center w-100 p-4">
        ...
        <div class="card-body">
            <form:form class="mt-3 mb-5"
                ...
                <div class="mb-3 text-start">
                    <form:label path="phoneNumber" class="form-label">Numéro de téléphone</form:label>
                    <form:input class="form-control rounded-pill" path="phoneNumber" maxlength="13" />
                    <form:errors path="phoneNumber" class="errorMsg"/>
                </div>
                <div class="mb-3 text-start">
                    <form:label path="address" class="form-label">Adresse de livraison*</form:label>
                ...
                <div class="mb-3 text-start">
                    <form:label path="confirmedPassword" class="form-label">Confirmer le mot de passe*</form:label>
                    <form:input class="form-control rounded-pill" maxlength="30" path="confirmedPassword" type="password"/>
                    <form:errors path="password" class="errorMsg"/>
                </div>
                <form:button class="btn btn-dark rounded-pill px-5 mt-3">Send</form:button>
